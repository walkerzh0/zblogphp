...
<div id="divMain">
  ...
  foreach ($array as $key => $reg) {    	 	 	 	     		 			 	      						
	  ...
	  echo '购买价格：';    	  	  	        		         		 			
	  echo '</td>';     		  	 	      		 	 	     		 	 		
	  echo '<td width="30%" valign="middle" align="left" style="color: #ff0000;">'.$reg->Pay.'<small style="float:right"><a onclick="$(\'#inputpostid\').val(\''.$reg->LogID.'\');" href="javascript:;">文章ID：'.$reg->LogID.'</a></small></td>';    		   	      			   		    		  			 
	  echo '   <td width="10%" valign="middle" align="right">';    		   			    	 		   	    		    		
	  ...
	  echo '  </td>';    		  	 		     	 			        	    	
	  if($reg->LogID==0){    	 	 	        	   	             	
		echo '   <td width="30%" valign="middle" align="left">(支付宝充值)'.$reg->Title.'</span></a></td>';		       	 		      		 	 	      			 		 
	  }else{                				 	      		   			
