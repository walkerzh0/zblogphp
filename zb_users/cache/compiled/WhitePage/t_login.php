    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-trans layui-form-item layadmin-user-login-other">
          ...
          <?php } ?>
          <a href="<?php  echo $host;  ?><?php  echo $zbp->Config('YtUser')->YtUser_Register;  ?>" class="layadmin-user-jump-change layadmin-link">注册帐号</a>
        </div>
      </div>
    </div>
    ...
    form.on('submit(LAY-user-login-submit)', function(obj){
        ...
        ,done: function(res){     
            ...
            ,time: 1000
                ...
                location.href = "<?php  echo $host;  ?><?php  echo $zbp->Config('YtUser')->YtUser_Index;  ?>";
            });
        },
        error:function(res){
