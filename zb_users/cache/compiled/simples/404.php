...
.clear { zoom: 1 }
body {
    background: #dfdfdf url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/images/404_bg.jpg) repeat;
...
#main #content h2 {
    background: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/images/404_s-divider.jpg) no-repeat;
...
#main #content .utilities form  .input-container button#search {
    ...
    top: 9px;
    right: 0;
    background: white url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/images/404_search.png) no-repeat;
    width: 18px;
    height: 18px;
    border: none;
    cursor: pointer;
...
@media screen and (max-width: 610px){
	#main,#main #content{width: 99%;margin: 0 auto;}
}
@media screen and (max-width: 480px){
	#main #content .utilities form .input-container{width:100%}
	#main #content .utilities form .input-container input[type=text] {
		width: 97%;
	}
}
