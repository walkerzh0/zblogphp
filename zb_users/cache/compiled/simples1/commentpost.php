...
<?php if ($user->ID>0) { ?>	
	<li>用户：<input type="text" name="inpName" id="inpName" value="<?php  echo $user->StaticName;  ?>" /><br/></li>
	<li>邮箱：<input type="text" name="inpEmail" id="inpEmail" value="<?php  echo $user->Email;  ?>" /><br/></li>
	<li>主页：<input type="text" name="inpHomePage" id="inpHomePage" value="<?php  echo $user->HomePage;  ?>" /><br/></li>	
<?php }else{  ?>
