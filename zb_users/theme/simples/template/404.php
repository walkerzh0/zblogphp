...
.clear { zoom: 1 }
body {
    background: #dfdfdf url({$host}zb_users/theme/{$theme}/style/images/404_bg.jpg) repeat;
...
#main #content h2 {
    background: url({$host}zb_users/theme/{$theme}/style/images/404_s-divider.jpg) no-repeat;
...
#main #content .utilities form  .input-container button#search {
    ...
    top: 9px;
    right: 0;
    background: white url({$host}zb_users/theme/{$theme}/style/images/404_search.png) no-repeat;
    width: 18px;
    height: 18px;
    border: none;
    cursor: pointer;
