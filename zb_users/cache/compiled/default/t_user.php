            ...
            <input id="edtGuid" name="Guid" type="hidden" value="<?php  echo $user->Guid;  ?>" />
              <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-col-lg6">
                  ...
                  <div class="layui-input-block">
                    <input type="text" name="meta_Add" value="<?php  echo $user->Metas->Add;  ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                  </div>
                </div>
              </div>
              <div class="layui-row layui-col-space10 layui-form-item">
                <div class="layui-col-lg6">
                  ...
                  <div class="layui-input-block">
                    <input type="text" name="Email" value="<?php  echo $user->Email;  ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-col-lg6">
                  <label class="layui-form-label">网站：</label>
                  <div class="layui-input-block">
                    <input type="text" name="HomePage" value="<?php  echo $user->HomePage;  ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                  </div>
                </div>
              </div>
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <textarea name="Intro" placeholder="" class="layui-textarea"><?php  echo $user->Intro;  ?></textarea>
                </div>
              </div>
