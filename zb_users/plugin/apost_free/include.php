...
function apost_free_box() {
    ...
    if(isset($_GET['apost_free'])){
	    ...
	    $article->Content .='<script src="'.$zbp->host.'zb_system/script/jquery-2.2.4.min.js" type="text/javascript"></script><script src="http://localhost/zblogphp/zb_system/script/zblogphp.js" type="text/javascript"></script><script src="http://localhost/zblogphp/zb_system/script/c_html_js_add.php" type="text/javascript"></script>';
