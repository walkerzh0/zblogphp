...
<body>
<script type="text/javascript" src="//qzonestyle.gtimg.cn/qzone/hybrid/app/404/search_children.js" homePageName="返回<?php  echo $name;  ?>" homePageUrl="<?php  echo $host;  ?>"></script>
</body>
</html>