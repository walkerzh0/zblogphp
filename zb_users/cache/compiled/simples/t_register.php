...
<head>
  ...
  <link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/YtUser/layuiadmin/style/login.css" media="all">
</head>
  ...
  <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <?php if ($zbp->Config('YtUser')->inv_on==1) { ?>
        <input type="hidden" name="rootid" id="rootid" value="<?php  echo $article->u;  ?>" />
        <?php } ?>
        ...
        <div class="layui-trans layui-form-item layadmin-user-login-other">
          <?php if ($zbp->Config('YtUser')->appkey !="") { ?>
          <label>社交账号登入</label>
          <a href="<?php  echo $host;  ?>zb_users/plugin/YtUser/login.php"><i class="layui-icon layui-icon-login-qq"></i></a>
          <?php } ?>
          <a href="<?php  echo $host;  ?><?php  echo $zbp->Config('YtUser')->YtUser_Login;  ?>" class="layadmin-user-jump-change layadmin-link layui-hide-xs">用已有帐号登入</a>
          <a href="<?php  echo $host;  ?><?php  echo $zbp->Config('YtUser')->YtUser_Login;  ?>" class="layadmin-user-jump-change layadmin-link layui-hide-sm layui-show-xs-inline-block">登入</a>
        </div>
      </div>
    </div>
