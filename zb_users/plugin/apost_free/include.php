...
function apost_free_box() {
    ...
    if(isset($_GET['apost_free'])){
	    ...
	    $article->UEditor ='<script type="text/javascript" src="'.$zbp->host.'zb_users/plugin/UEditor/ueditor.config.php"></script><script type="text/javascript" src="'.$zbp->host.'zb_users/plugin/UEditor/ueditor.all.min.js"></script><textarea name="Content" id="editor_Content" datatype="*"></textarea><script type="text/javascript">var editor = new baidu.editor.ui.Editor({toolbars:[["Paragraph","FontSize", "bold", "italic", "forecolor", "backcolor", "pasteplain", "link", "justifyleft", "justifycenter", "justifyright", "Undo","Redo"]],initialFrameHeight: 350,});editor.render("editor_Content");editor.sync("Content"); </script>';
