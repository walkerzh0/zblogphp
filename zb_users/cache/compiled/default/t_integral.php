      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-col-md12">
            <div class="layui-card">
              <div class="layui-card-body">
              用户积分:<?php  echo $user->Price;  ?><br>
              充值介绍：<?php  echo $zbp->Config('YtUser')->integral_text;  ?><br>
              </div>
            </div>
          </div>
    ...
    form.on('submit(component-form-element)', function(data){
        ...
        ,done: function(res){
          layer.msg('修改成功', {
            ...
            location.href = '<?php  echo $host;  ?><?php  echo $zbp->Config('YtUser')->YtUser_Integral;  ?>';
          });
        },
        error:function(res){
            layer.msg($(res.responseText).find('member value string').text());
            $("#reg_verfiycode").attr("src",basehost+"zb_system/script/c_validcode.php?id=Integral&amp;tm="+Math.random());
        }
      });
      return false;
    });
