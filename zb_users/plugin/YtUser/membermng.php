...
$tabletds[] = '         VIP：';    						      	   	 	     			   		
$tabletds[] = '     </td>';       					      	 			     	  		   
$tabletds[] = '     <td valign="middle" align="left"'.($member->YtUser('Vipendtime')<time()?' style="color:red"':'').'>' . ($member->YtUser('Vipendtime') > time()?date("Y-m-d H:i:s",$member->YtUser('Vipendtime')):'已过期') . '</td>';      	 	  	        	  	     		 				
$tabletds[] = ' </tr>';     	 	 	       	 	 		     	 	  	  
$tabletds[] = ' <tr>';    		  	       		  		       	 	  	 
