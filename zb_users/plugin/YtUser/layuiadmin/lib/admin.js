  ...
  ,admin = {
    ...
    ,sendAuthCode: function(options){
      options = $.extend({
        ...
        ,elemckcode: '#LAY-user-login-mobilecode'
      }, options);
      ...
      options.elemckcode = $(options.elemckcode);
      btn.on('click', function(){
        var elemPhone = options.elemPhone
        ,elemckcode=options.elemckcode
        ,value = elemPhone.val()
        ,codes=elemckcode.val();
// console.log(elemcode);
        ...
        admin.req($.extend(true, {
          ...
          error:function(res){
              ...
              $("#reg_verfiycode").attr("src",basehost+"zb_system/script/c_validcode.php?id=register&amp;tm="+Math.random());
          }
        }, options.ajax));
      });
    }
